                        ...
                        <div class="col-lg-10">
                            <div class="card mb-grid">
                                <div class="card-header">
                                    <div class="card-header-title">Product Create</div>
                                </div>
                                <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-2 input-credit-card" name="name" id="name" type="text" placeholder="Enter name">
                                        </div>

                                        <div class="form-group">
                                            <label class="form-label">Description</label>
                                            <input class="form-control mb-2 input-credit-card" name="description" id="description" type="text" placeholder="Enter description">
                                        </div>

                                        <div class="form-group">
                                            <label class="form-label">Price</label>
                                            <input class="form-control mb-2 input-credit-card" name="price" id="price" type="text" placeholder="Enter price">
                                        </div>

                                        <div class="form-group">
                                            <input class="form-control  mb-2 input-credit-card" name="image" type="file" id="fileInput">
